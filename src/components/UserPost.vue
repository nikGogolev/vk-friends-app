<template>
  ...
  <div class="post-attchments">
    <template v-for="(attachment, index) in post.attachments" :key="index">
      <div class="post-photo" v-if="attachment.photo">
        <img :src="attachment.photo.sizes[2].url" alt="post photo" />
      </div>
      <div class="post-video" v-if="attachment.video">
        <video :src="attachment.video.url"></video>
      </div>
    </template>
  </div>

  <div class="post_icons">
    <div class="post_icons-group">
      <svg
        height="24"
        viewBox="0 0 24 24"
        width="24"
