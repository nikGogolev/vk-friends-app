...
export const AUTH_URL = `https://oauth.vk.com/authorize?client_id=8228596&display=page&redirect_uri=${LOCAL_URL}&scope=friends,photos,status,offline,groups,email&response_type=token&v=5.131&state=123456`;
